...
namespace ChildcareManagementERP.Api.Services
{
    public class LinkGuardianChildService : ILinkGuardianChildService
    {
        ...
        public async Task<bool> ExistsLinkGuardianChildAsync(int guardianId, int childId)
        {
        ...
        public async Task RemoveLinkGuardianChildAsync(int guardianId, int childId)
        {
