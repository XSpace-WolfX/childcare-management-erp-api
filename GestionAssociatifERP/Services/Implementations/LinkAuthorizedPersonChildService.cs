...
namespace GestionAssociatifERP.Services
{
    public class LinkAuthorizedPersonChildService : ILinkAuthorizedPersonChildService
    {
        ...
        public async Task<bool> ExistsLinkAuthorizedPersonChildAsync(int childId, int authorizedPersonId)
        {
        ...
        public async Task RemoveLinkAuthorizedPersonChildAsync(int childId, int authorizedPersonId)
        {
