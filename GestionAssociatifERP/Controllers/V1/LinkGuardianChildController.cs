...
namespace GestionAssociatifERP.Controllers.V1
{
    ...
    public class LinkGuardianChildController : ControllerBase
    {
        ...
        {
            var result = await _linkGuardianChildService.ExistsLinkGuardianChildAsync(childId, guardianId);
        ...
        {
            await _linkGuardianChildService.RemoveLinkGuardianChildAsync(childId, guardianId);
