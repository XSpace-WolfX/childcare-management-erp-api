...
namespace GestionAssociatifERP.Controllers.V1
{
    ...
    public class LinkAuthorizedPersonChildController : ControllerBase
    {
        ...
        // GET: api/v1/linkauthorizedpersonchild/authorized-person/{personneAutoriseeId}
        [HttpGet("authorized-person/{personneAutoriseeId}")]
        ...
        // GET: api/v1/linkauthorizedpersonchild/child/{enfantId}
        [HttpGet("child/{enfantId}")]
        ...
        {
            var result = await _linkAuthorizedPersonChildService.ExistsLinkAuthorizedPersonChildAsync(childId, authorizedPersonId);
        ...
        {
            await _linkAuthorizedPersonChildService.RemoveLinkAuthorizedPersonChildAsync(childId, authorizedPersonId);
